...
# Handle version file specially - append commit hash if installing from repo
version_dist_path="admin-dist/szuru_admin_version.py"
version_repo_path="server/szuru_admin_version.py"
